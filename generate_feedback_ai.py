...
## 学生段落（约 100-150 字）
每个学生写一段。既要传达他说了什么、参与了哪些环节，也要有你对他的观察和判断。不要写成纯陈述——家长看长图、单人卡就能知道他说了什么，反馈的价值在于你作为老师的判断：他哪里想得有意思、他的表达有什么特点、他跟别人不一样的地方在哪。

要求：
- 开头直接写内容，不要「这节课他参与了挺多话题」「XX发言挺活跃」之类总起句
- 每个话题一两句带过他说了什么，然后点一下他的角度或表达的特点——不是夸"说得好"，是说清楚哪里有意思。比如「他把讨论从A拉回到B」「他从自己的经历里找到了一个反例」「他一直在追问'为什么'，不满足于表面的答案」「他的想法跟其他人都不一样，坚持自己的一套逻辑」
- 不引原话
- 不同学生的描述要有差异——如果两个学生写出来差不多，说明没抓住各自的特点

禁止以下空洞评价词（但具体的、有内容的判断是允许的）：
展现/体现/呈现、理解了、抓住了、有深度、批判性思维、同理心、逻辑清晰、表达能力强、落在地板上、不讲空道理、活跃、投入、积极、主动、全程在线
- 不推测动机
- 不做精确归因
...
def build_student_prompt(title, student_name, speeches, history_text, gender_info=""):
    ...
    parts.append("个人段落：以「说到…」「谈到…」「聊到…」「提到…」等起头，覆盖他参与过的所有话题。每个话题用一句话写他说的方向，然后加半句你的观察——他的角度有什么特点、他的表达方式跟别人有什么不同。不要纯陈述他说了什么，要点出值得注意的地方。")
    parts.append("不引原话。禁止空洞评价词（展现/体现/落在地板上/不讲空道理/批判性思维/同理心/逻辑清晰/活跃/投入/积极/主动/全程在线），但具体的、有内容的判断是好的——比如'他把问题反过来想''他从生活里找到了例子''他一直在追问原因'。")
    parts.append("延伸用「可以跟他/她聊聊……」开头。段落之间空一行。纯文本。不要称呼和标题。")
    return "\n".join(parts)
